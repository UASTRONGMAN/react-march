...
import {IResponseRegistrationModel} from "../models/IResponseRegistrationModel";
...
const services = {
    registration: async (data: IRegistrationModel): Promise<AxiosResponse<IResponseRegistrationModel>> => {
